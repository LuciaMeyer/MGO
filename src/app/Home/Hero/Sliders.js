  ...
  const [heroSliders, setheroSliders] = useState([
    {
      ...
      subTitle:
        "Nos enfocamos en brindarte atención personalizada con profesionales altamente<br/>capacitados, asegurando tratamientos efectivos para tu salud dental. ",
      button: {
        text: "Conocenos",
        link: "/about",
      },
    },
    {
      ...
      subTitle:
        "Contamos con un equipo de expertos en odontología, comprometidos con la<br/>excelencia el bienestar de nuestros pacientes y un servicio personalizado.",
      button: {
        text: "Profesionales",
        link: "/doctors",
      },
