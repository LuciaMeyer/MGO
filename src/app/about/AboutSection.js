          ...
          <div className="row m-0">
            ...
            <div className="col-lg-6 col-md-12 p-0">
              <div className="about-content">
                <span>Meyer Gulisano Odontología</span>
                <h2 className="mt-4">Breve historia de MGO</h2>
                <p>
                Con <span>65 años de trayectoria</span>, MGO sigue en la búsqueda de la excelencia en el cuidado dental.
